...
<body class="materialdesign">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">职位类别</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <script>
		...
		$.ajax({ 
			type: "GET",
			url: baseUrl+"value/zhiweileibie/"+xColumnName+'/'+yColumnName,
			data:{ },
		...
		function group(colName){
			$.ajax({ 
                type: "GET",
                url: baseUrl+"group/zhiweileibie/"+colName,
             	data:{	tableName: "zhiweileibie",
                    	columnName: colName
					 },
                beforeSend: function(xhr) {
                    xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
