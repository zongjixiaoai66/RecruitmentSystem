                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">留言板管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>留言板<span class="table-project-n">列表</span></h1>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="useridIcon" onclick="sort('userid')" class="fa fa-sort" aria-hidden="true"></i>留言人id</th>
																																																			<th><i id="usernameIcon" onclick="sort('username')" class="fa fa-sort" aria-hidden="true"></i>学生名</th>
																																																																			<th>留言内容</th>
																																																																																	<th>回复内容</th>
																																																			<th>
													操作
