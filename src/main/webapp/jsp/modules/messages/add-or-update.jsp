                                                ...
                                                <div class="all-form-element-inner">
                                                    <form id="addOrUpdateForm" action="#">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">留言人id</label>    
                                                                                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                <input id="username" name="username" class="form-control" placeholder="学生名">
                                                                                                                                </div>
                                                            </div>
                                                        </div>
                                                                                                            <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">留言内容</label>    
                                                                                                                                </div>
                                                                <div class="col-lg-2">
																	<textarea id="content" name="content" class="form-control" placeholder="留言内容" rows="5" cols="20">
																	</textarea>
                                                                                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">回复内容</label>    
                                                                                                                                </div>
                                                                <div class="col-lg-2">
																	<textarea id="reply" name="reply" class="form-control" placeholder="回复内容" rows="5" cols="20">
																	</textarea>
                                                                                                                                </div>
                                                            </div>
                                                        </div>
