...
<body class="materialdesign">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">注册学生管理</span></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="sparkline13-list shadow-reset">
								<div class="sparkline13-hd">
									<div class="main-sparkline13-hd">
										<h1>
											注册学生<span class="table-project-n">列表</span>
										</h1>
										...
										<table id="table" data-toggle="table" data-resizable="true">
											<thead>
												<tr>
													...
													<th><i id="usernameIcon" onclick="sort('username')"
														class="fa fa-sort" aria-hidden="true"></i>学生名</th>
													<th><i id="mimaIcon" onclick="sort('mima')"
														class="fa fa-sort" aria-hidden="true"></i>密码</th>
													<th><i id="nameIcon" onclick="sort('name')"
														class="fa fa-sort" aria-hidden="true"></i>姓名</th>
													<th><i id="sexIcon" onclick="sort('sex')"
														class="fa fa-sort" aria-hidden="true"></i>性别</th>
													<th><i id="ageIcon" onclick="sort('age')"
														class="fa fa-sort" aria-hidden="true"></i>年龄</th>
													<th><i id="phoneIcon" onclick="sort('phone')"
														class="fa fa-sort" aria-hidden="true"></i>电话</th>
													<th>照片</th>
													<th><i id="emailIcon" onclick="sort('email')"
														class="fa fa-sort" aria-hidden="true"></i>邮箱</th>
								...
								<div class="row">
									...
									<div class="col-lg-9">
										<div class="login-horizental cancel-wp pull-left">
											<button data-dismiss="modal" class="btn btn-white"
												type="submit">取消</button>
											<button onclick="sh()" id="addRowButton"
												class="btn btn-sm btn-primary login-submit-cs" type="button">提交</button>
										</div>
									</div>
								</div>
							</div>
	...
	<%@ include file="../../static/toLogin.jsp"%>
		...
		function setDataRow(item) {
			...
			var pictureImgUrl = baseUrl + 'upload/' + item.picture;
			pictureImg.setAttribute('src', pictureImgUrl);
			...
			detailBtn.setAttribute("class",
					"btn btn-custon-four btn-primary btn-sm 查看");
