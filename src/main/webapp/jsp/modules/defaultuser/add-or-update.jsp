								...
								<div class="row">
									...
									<div class="col-lg-6">
										<ul class="breadcome-menu">
											...
											<li><span class="bread-blod">注册学生</span></li>
										</ul>
									</div>
								</div>
							</div>
												...
												<div class="all-form-element-inner">
													<form id="addOrUpdateForm" action="#">
																...
																<div class="col-lg-2">
																	<div class="form-select-list">
																		<select id="sexSelect" name="sex"
																			...
																			<option name="sexOption" value="未选择"></option>
														...
														<div class="form-group-inner">
															<div class="row">
																<div class="col-lg-3">
																	<label class="login2 pull-right pull-right-pro">年龄</label>
																</div>
																<div class="col-lg-2">
														...
														<div class="form-group-inner">
															<div class="row">
																<div class="col-lg-3">
																	<label class="login2 pull-right pull-right-pro">电话</label>
																</div>
																<div class="col-lg-2">
