                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">线路追踪表管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>线路追踪表<span class="table-project-n">列表</span></h1>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="useridIcon" onclick="sort('userid')" class="fa fa-sort" aria-hidden="true"></i>学生id</th>
																																																			<th><i id="titleIcon" onclick="sort('title')" class="fa fa-sort" aria-hidden="true"></i>标题</th>
																																																																			<th>线路所有节点,用逗号分割</th>
																																																																	<th><i id="curnodeIcon" onclick="sort('curnode')" class="fa fa-sort" aria-hidden="true"></i>当前节点</th>
																																					<th>
													操作
												</th>
                                                </tr>
    ...
    <script>
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
            				...
            				var allnodeCell  = document.createElement('td');

                				  if(item.allnode != null && item.allnode != "" && item.allnode.length >= 11){
				  	allnodeCell.innerHTML = item.allnode.substring(0, 10) + "..."; 
				  }else{
				  	allnodeCell.innerHTML = item.allnode;
				  }

				
									row.appendChild(allnodeCell);
				
            				var curnodeCell  = document.createElement('td');

                				 curnodeCell.innerHTML = item.curnode;

				
									row.appendChild(curnodeCell);
