                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">论坛表管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>论坛表<span class="table-project-n">列表</span></h1>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="titleIcon" onclick="sort('title')" class="fa fa-sort" aria-hidden="true"></i>帖子标题</th>
																																																																			<th>帖子内容</th>
																																																																	<th><i id="parentidIcon" onclick="sort('parentid')" class="fa fa-sort" aria-hidden="true"></i>父节点id</th>
																																																			<th><i id="useridIcon" onclick="sort('userid')" class="fa fa-sort" aria-hidden="true"></i>学生id</th>
																																																			<th><i id="isdoneIcon" onclick="sort('isdone')" class="fa fa-sort" aria-hidden="true"></i>是否关闭[关闭/开放]</th>
																																					<th>
													操作
												</th>
                                                </tr>
