                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">论坛表</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <div class="all-form-element-inner">
                                                    <form id="addOrUpdateForm" action="#">
                                                        <input id="updateId" name="id" type="hidden">    
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                                                                                    <label class="login2 pull-right pull-right-pro">帖子标题</label>    
                                                                                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                                                                                    <label class="login2 pull-right pull-right-pro">父节点id</label>    
                                                                                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                                                                                    <label class="login2 pull-right pull-right-pro">是否关闭[关闭/开放]</label>    
                                                                                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">帖子内容</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <script id="contentEditor" type="text/plain" style="width:650px;height:230px;"></script>
