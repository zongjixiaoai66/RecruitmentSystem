		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.zhiweileibie" type="text" name="zhiweileibie" id="zhiweileibie" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.zhiweijianjie" type="text" name="zhiweijianjie" id="zhiweijianjie" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">企业号：</label>
						<div class="layui-input-block">
							<input v-model="detail.qiyehao" type="text" name="qiyehao" id="qiyehao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-inline" style="line-height: 50px;">
							<input type="hidden" :value="detail.jianli" id="jianli" name="jianli" />
                            <button type="button" class="layui-btn btn-theme" id="jianliUpload">
								<i class="layui-icon">&#xe67c;</i>上传简历
							</button>
							<a download="简历" :href="detail.jianli">点击下载简历</a>
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				http.request('config/list', 'get', {
					...
					elem: '#shenqingriqi'
												                ...
												                var jianliUpload = upload.render({
					//绑定元素
					elem: '#jianliUpload',
					//上传接口
					...
					// 上传成功
						...
						if (res.code == 0) {
							...
							jquery('#jianli').val(url);
                            vue.detail.jianli = url;
						} else {
							layer.msg(res.msg, {
								time: 2000,
								icon: 5
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('zhiweishenqing' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
