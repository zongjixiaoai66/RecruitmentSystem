				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="zhiweileibie" id="zhiweileibie">
									<option value="">请选择</option>
									<option v-for="(item,index) in zhiweileibie" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="zhiweijianjie" id="zhiweijianjie" placeholder="职位简介" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="qiyehao" id="qiyehao" placeholder="企业号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																...
                																http.request(`option/zhiweileibie/zhiweileibie`,'get',{},(res)=>{
					vue.zhiweileibie = res.data
				});
																// 上传图片
